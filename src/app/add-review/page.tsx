        ...
        >
          ...
          <div>
            ...
            <div className="relative w-full mt-2">
              <div className="absolute inset-x-0 flex justify-between text-gray-600 dark:text-gray-400 text-sm">
                {[1, 2, 3, 4, 5].map((val) => (
                  <span key={val} className="w-12 text-center">
                    {val === 1
                      ? '1 - Very Easy'
                      : val === 3
                        ? '3 - Average'
                        : val === 5
                          ? '5 - Rocket Science Level'
                          : val}
                  </span>
                ))}
              </div>
          ...
          <div>
            ...
            <RadioGroup defaultValue="yes" className="space-y-3 mt-3">
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="yes" id={yesId1} />
                <label htmlFor={yesId1} className="text-md font-medium">
                  Yes
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="no" id={noId1} />
                <label htmlFor={noId1} className="text-md font-medium">
                  No
                </label>
              </div>
            </RadioGroup>
          ...
          <div>
            ...
            <RadioGroup defaultValue="yes" className="space-y-3 mt-3">
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="yes" id={yesId2} />
                <label htmlFor={yesId2} className="text-md font-medium">
                  Yes
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="no" id={noId2} />
                <label htmlFor={noId2} className="text-md font-medium">
                  No
                </label>
              </div>
            </RadioGroup>
          ...
          <div>
            ...
            <RadioGroup defaultValue="yes" className="space-y-3 mt-3">
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="yes" id={yesId3} />
                <label htmlFor={yesId3} className="text-md font-medium">
                  Yes
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="no" id={noId3} />
                <label htmlFor={noId3} className="text-md font-medium">
                  No
                </label>
              </div>
            </RadioGroup>
          ...
          <div>
            ...
            <RadioGroup defaultValue="yes" className="space-y-3 mt-3">
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="yes" id={yesId4} />
                <label htmlFor={yesId4} className="text-md font-medium">
                  Yes
                </label>
              </div>
              <div className="flex items-center space-x-3">
                <RadioGroupItem value="no" id={noId4} />
                <label htmlFor={noId4} className="text-md font-medium">
                  No
                </label>
              </div>
            </RadioGroup>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 flex-wrap">
              {selectedTags.map((tag) => (
                <Badge
                  key={String(tag)}
                  className="flex items-center space-x-1 px-3 py-1 bg-blue-600 text-white"
                >
                  {tag}
                  <X
